...
home_content -->
  html([
    ...
    p('Retouvez-moi sur les réseaux sociaux à l\u0027aide des liens en haut à droite'),
    h1('Présentation du site'),
    p([
      'Le site sur lequel vous naviguez actuellement est différent de ce qui se fait actuellment. ',
      'En effet, celui-ci a entièrement été écrit en Prolog.'
    ]),
